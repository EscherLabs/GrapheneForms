...
gform.processConditions=function(e,n){if("string"==typeof e&&("show"!==e&&"edit"!==e&&"parse"!==e||(e=this.item[e])),"boolean"==typeof e&&n.call(this,e),"function"==typeof e&&n.call(this,e.call(this)),"object"==typeof e){var t=function(e,n){n.call(this,gform._rules.call(this,e))}.bind(this,e,n);gform._subscribeByName.call(this,e,t)}return!0},gform._subscribeByName=function(e,n){for(var t in e)void 0!==e[t].name?this.owner.on("change:"+e[t].name,n):"object"==typeof e[t].conditions&&gform._subscribeByName.call(this,e[t].conditions,n)},gform._rules=function(e,n){n=n||"and";return _.reduce(e,function(e,t){var i;return void 0!==t.conditions?(i=gform._rules.call(this,t.conditions,t.op),console.log(i)):i=gform.conditions[t.type](this,t),"or"==n?e||i:e&&i}.bind(this),"and"==n)},gform.conditions={requires:function(e,n){var t,i=e.parent.filter({name:n.name,parsable:!0});if(i.length>0)t=i[0];else{if(e.name!=n.name)return!1;t=e}return t.satisfied()},not_matches:function(e,n){var t,i=e.parent.filter({name:n.name,parsable:!0});if(i.length>0)t=i[0];else{if(e.name!=n.name)return!1;t=e}var r=n.value,a=t.value;return"object"==typeof r&&null!==a?-1==r.indexOf(a):r!==a},test:function(e,n){return n.test.call(this,e,n)},contains:function(e,n){var t,i=e.parent.filter({name:n.name,parsable:!0});if(i.length>0)t=i[0];else{if(e.name!=n.name)return!1;t=e}var r=n.value,a=t,o=null;return void 0!==a&&(o=0!=a.array?e.parent.find(n.name).parent.get()[n.name]:a.value,"object"!=typeof r||null===o?void 0!==o&&-1!==o.indexOf(r):"object"==typeof o?_.intersection(r,o).length>0:"string"==typeof o?_.some(r,(function(e){return o.indexOf(e)>=0})):void 0)},matches:function(e,n){var t,i=e.parent.filter({name:n.name,parsable:!0});if(i.length>0)t=i[0];else{if(e.name!=n.name)return!1;t=e}var r=n.value,a=t.value;return"object"==typeof r&&null!==a?-1!==r.indexOf(a):r==a}};
