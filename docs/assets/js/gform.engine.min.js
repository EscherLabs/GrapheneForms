var gform=function(t,e){"use strict";this.eventBus=new gform.eventBus({owner:"form",item:"field",handlers:t.events||{}},this),this.on=this.eventBus.on,this.sub=this.on,this.pub=this.eventBus.dispatch,this.dispatch=this.pub,this.sub("reset",function(t){t.form.set(t.form.options.data)}),this.sub("clear",function(t){t.form.set()}),this.options=_.assignIn({legend:"",default:gform.default,data:"search",columns:gform.columns,name:gform.getUID()},this.opts,t),this.options.fields=this.options.fields.concat(this.options.actions||[{type:"cancel"},{type:"save"}]),"string"==typeof this.options.data&&(this.options.data=window.location[this.options.data].substr(1).split("&").map(function(t){return t.split("=")}).reduce(function(t,e){return t[e[0]]=decodeURIComponent(e[1]),t},{})),this.options.sections&&_.each(_.filter(this.options.fields,{type:"fieldset"}),function(t,e){return t.index=e,t.section=!0,t.id=gform.getUID(),t}),this.el=e||t.el,"string"==typeof this.el?this.el=document.querySelector(this.el):"object"==typeof this.el?this.el:e="",this.pub("initialize");var n=function(){void 0===this.el&&(this.options.renderer="modal",this.el=gform.create(gform.render(this.options.template||"modal_container",this.options)),gform.addClass(this.el,"active"),this.sub("close",function(t){t.form.modal("hide")}),this.sub("save",function(t){gform.removeClass(t.form.el,"active")}),this.el.querySelector(".close").addEventListener("click",function(t){this.pub("cancel",this)}.bind(this)),document.addEventListener("keyup",function(t){"Escape"===t.key&&this.pub("cancel",this)}.bind(this))),this.options.clear&&"modal"!=this.options.renderer&&(this.el.innerHTML=gform.render(this.options.sections+"_container",this.options)),this.container=this.el.querySelector("form")||this.el,this.rows={},this.fields=_.map(this.options.fields,gform.createField.bind(this,this,this.options.data||{},null,null)),_.each(this.fields,gform.inflate.bind(this,this.options.data||{})),gform.each.call(this,function(t){t.owner.pub("change:"+t.name,t)}),gform.instances[this.options.name]=this};this.restore=n.bind(this),this.get=this.toJSON=gform.toJSON.bind(this),this.reflow=gform.reflow.bind(this),this.find=gform.find.bind(this),this.set=function(t,e){"string"==typeof t&&this.find(t).set(e),"object"==typeof t&&_.each(t,function(t,e){var n=this.find(e);void 0!==n&&n.set(t)}.bind(this)),null==t&&gform.each.call(this,function(t){t.set("")})}.bind(this),this.isActive=!0,this.destroy=function(){this.pub(["close","destroy"]),this.el.innerHTML="",delete gform.instances[this.options.name],this.pub("destroyed")},n.call(this);var i=this.el.querySelector("ul.tabs");return null!==i&&i.addEventListener("click",function(t){"LI"==t.target.nodeName&&(t.preventDefault(),gform.removeClass(this.el.querySelector("ul.tabs .active"),"active"),gform.removeClass(this.el.querySelector(".tab-pane.active"),"active"),gform.addClass(t.target,"active"),gform.addClass(this.el.querySelector(t.target.parentElement.attributes.href.value),"active"))}.bind(this)),(this.options.autoFocus||gform.options.autoFocus)&&gform.types[this.fields[0].type].focus.call(this.fields[0]),this.el.addEventListener("click",function(t){var e;if(t.target.dataset.id&&(e=gform.findByID.call(this,t.target.dataset.id)),t.target.classList.contains("gform-add")){if(t.stopPropagation(),(s=_.countBy(e.parent.fields,{name:e.name}).true)<(e.array.max||5)){var n=_.findIndex(e.parent.fields,{id:e.id}),i=gform.createField.call(this,e.parent,{},e.el,null,e.item,null,null,s);e.parent.fields.splice(n+1,0,i),e.parent.reflow(),_.each(_.filter(e.parent.fields,{name:e.name}),function(t,e){t.index=e,t.label=gform.renderString(t.item.label,t),t.el.querySelector("legend,label").innerHTML=t.label}),gform.each.call(e.owner,function(t){t.owner.pub("change:"+t.name,t)}),gform.types[i.type].focus.call(i),e.owner.pub(["change","change:"+e.name,"create","create:"+e.name,"inserted","inserted:"+e.name],e),s++}var o=function(t,e){gform.toggleClass(e,"hidden",t)};_.each(document.body.querySelectorAll('[data-name="'+e.name+'"] .gform-add'),o.bind(null,s>=(e.array.max||5))),_.each(document.body.querySelectorAll('[data-name="'+e.name+'"] .gform-minus'),o.bind(null,!(s>(e.array.min||1))))}if(t.target.classList.contains("gform-minus")){var s;if(t.stopPropagation(),(s=_.countBy(e.parent.fields,{name:e.name}).true)>(e.array.min||1)){n=_.findIndex(e.parent.fields,{id:e.id});e.parent.fields.splice(n,1),e.parent.reflow(),e.target?this.container.querySelector(e.target).removeChild(e.el):_.each(_.filter(e.parent.fields,{name:e.name}),function(t,e){t.index=e,t.label=gform.renderString(t.item.label,t),t.el.querySelector("label").innerHTML=t.label}),e.owner.pub(["change","change:"+e.name,"removed","removed:"+e.name],e),s--}else e.set(null);o=function(t,e){gform.toggleClass(e,"hidden",t)};_.each(document.body.querySelectorAll('[data-name="'+e.name+'"] .gform-add'),o.bind(null,s>=(e.array.max||5))),_.each(document.body.querySelectorAll('[data-name="'+e.name+'"] .gform-minus'),o.bind(null,!(s>(e.array.min||1))))}}.bind(this)),this};gform.each=function(t){_.each(this.fields,function(e){t(e),void 0!==e.fields&&gform.each.call(e,t)})},gform.find=function(t){var e=t.split("."),n=_.find(this.fields,{name:e.shift()});return void 0!==n?void 0!==n.find?n.name==t?n:n.find(e.join(".")):n:void 0!==this.parent&&"function"==typeof this.parent.find?this.parent.find(t):void 0},gform.findByID=function(t){var e=!1;return _.each(this.fields,function(n){n.id==t&&(e=n),e||void 0===n.fields||(e=gform.findByID.call(n,t))}),e},gform.toJSON=function(t){if("string"==typeof t&&t.length>0)return t=t.split("."),_.find(this.fields,{name:t.shift()}).get(t.join("."));var e={};return _.each(this.fields,function(t){t.parsable&&(t.array?(e[t.name]=e[t.name]||[],e[t.name].push(t.get())):e[t.name]=t.get())}.bind(this)),e},gform.m=function(t,e,n,i){function o(t,e){return t=t[(e=e.pop?e:e.split(".")).shift()]||"",0 in e?o(t,e):t}var s=gform.m,r="";e=_.isArray(e)?e:e?[e]:[],e=i?0 in e?[]:[1]:e;for(i=0;i<e.length;i++){var a,l="",c=0,f="object"==typeof e[i]?e[i]:{};(f=_.assign({},n,f))[""]={"":e[i]},t.replace(/([\s\S]*?)({{((\/)|(\^)|#)(.*?)}}|$)/g,function(t,e,n,i,d,p,u){c?l+=c&&!d||1<c?t:e:(r+=e.replace(/{{{(.*?)}}}|{{(!?)(&?)(>?)(.*?)}}/g,function(t,e,n,i,r,a){return e?o(f,e):i?o(f,a):r?s(o(f,a),f):n?"":new Option(o(f,a)).innerHTML}),a=p),d?--c||(u=o(f,u),r=/^f/.test(typeof u)?r+u.call(f,l,function(t){return s(t,f)}):r+s(l,u,f,a),l=""):++c})}return r},gform.reflow=function(){_.each(this.rows,function(t,e){this.container.removeChild(t.ref),delete this.rows[e]}.bind(this)),_.each(this.fields,function(t){if(t.columns>0){var e,n=t.parent.container.querySelectorAll("form > ."+t.owner.options.rowClass+",fieldset > ."+t.owner.options.rowClass);if(void 0!==(i=(n[n.length-1]||{}).id)&&(e=t.parent.rows[i]),void 0===e||e.used+parseInt(t.columns,10)+parseInt(t.offset,10)>t.owner.options.columns||1==t.row){var i=gform.getUID();(e={}).used=0,e.ref=document.createElement("div"),e.ref.setAttribute("id",i),e.ref.setAttribute("class",t.owner.options.rowClass),e.ref.setAttribute("style","margin-bottom:0;"),t.parent.rows[i]=e,t.parent.container.appendChild(e.ref)}e.used+=parseInt(t.columns,10),e.used+=parseInt(t.offset,10),e.ref.appendChild(t.el),t.row=i}})},gform.instances={},gform.inflate=function(t,e,n,i){var o=i;e.array&&(o=_.uniqBy(o,"name"));var s=_.findLast(o,{name:o[n].name});if(!s.array&&s.fields&&_.each(s.fields,gform.inflate.bind(this,t[s.name]||s.owner.options.data[s.name]||{})),s.array){var r=s.array.min||0;"object"!=typeof t[s.name]&&"object"==typeof s.owner.options.data[s.name]&&(t=s.owner.options.data),"object"==typeof t[s.name]&&t[s.name].length>1&&t[s.name].length>r&&(r=t[s.name].length);for(var a=1;a<r;a++){var l=gform.createField.call(this,s.parent,t,s.el,a,s.item,null,null,a);s.parent.fields.splice(_.findIndex(s.parent.fields,{id:s.id})+1,0,l),s=l}var c=function(t,e){gform.toggleClass(e,"hidden",t)};_.each(document.body.querySelectorAll('[data-name="'+s.name+'"] .gform-add'),c.bind(null,r>=(s.array.max||5))),_.each(document.body.querySelectorAll('[data-name="'+s.name+'"] .gform-minus'),c.bind(null,!(r>(s.array.min||1))))}},gform.normalizeField=function(t,e){e=e||null;t.type=t.type||this.options.default.type||"text";var n=_.assignIn({name:(gform.renderString(t.label)||"").toLowerCase().split(" ").join("_"),id:gform.getUID(),label:t.legend||t.name,validate:[],valid:!0,parsable:!0,visible:!0,editable:!0,parent:e,array:!1,columns:this.options.columns||gform.columns,offset:0,ischild:!(e instanceof gform)},this.opts,gform.default,this.options.default,(gform.types[t.type]||gform.types.text).defaults,t);return""==n.name&&(n.name=n.id),n.item=_.extend(t,{}),n},gform.createField=function(t,e,n,i,o,s,r,a){var l=gform.normalizeField.call(this,o,t);if(l.owner=this,l.columns>this.options.columns&&(l.columns=this.options.columns),l.array&&"object"==typeof(e[l.name]||l.owner.options.data[l.name])?l.value=(e[l.name]||l.owner.options.data[l.name])[i||0]||{}:l.value=e[l.name]||l.owner.options.data[l.name]||l.value,0!==l.item.value?l.array&&"object"==typeof e[l.name]?l.value=e[l.name][i||0]:"function"==typeof l.item.value?(l.valueFunc=l.item.value,l.derivedValue=function(){return l.valueFunc.call(l,l.owner.toJSON())},l.item.value=l.item.value=l.derivedValue(),l.owner.sub("change",function(){this.set.call(this,this.derivedValue())}.bind(l))):l.value=e[l.name]||l.value||"":l.value=0,l.index=a||0,l.label=gform.renderString(l.item.label||l.label,l),l.satisfied=l.satisfied||gform.types[l.type].satisfied.bind(l),l.update=gform.types[l.type].update.bind(l),l.destroy=gform.types[l.type].destroy.bind(l),l.active=function(){return this.parent.active()&&this.editable&&this.parsable&&this.visible},l.set=function(t,e){this.value==t&&null!=t||gform.types[this.type].set.call(this,t)||(this.value=t,e||this.owner.pub(["change:"+this.name,"change"],this))}.bind(l),l.get=l.get||gform.types[l.type].get.bind(l),l.render=l.render||gform.types[l.type].render.bind(l),l.el=gform.types[l.type].create.call(l),l.container=l.el.querySelector("fieldset")||l.el||null,void 0!==gform.types[l.type].reflow&&(l.reflow=gform.types[l.type].reflow.bind(l)||null),void 0!==gform.types[l.type].find&&(l.find=gform.types[l.type].find.bind(l)||null),l.target||l.section||!this.options.clear&&!l.isChild)l.target||(l.target='[name="'+l.name+'"],[data-inline="'+l.name+'"]'),null!=(d=this.el.querySelector(l.target))?d.appendChild(l.el):l.section&&l.owner.el.querySelector("."+l.owner.options.sections+"-content").appendChild(l.el);else if(l.columns>0){var c,f=l.parent.container.querySelectorAll("form > ."+l.owner.options.rowClass+",fieldset > ."+l.owner.options.rowClass);if(void 0!==(d=(f[f.length-1]||{}).id)&&(c=l.parent.rows[d]),void 0===c||c.used+parseInt(l.columns,10)+parseInt(l.offset,10)>this.options.columns||1==l.row){var d=gform.getUID();(c={}).used=0,c.ref=document.createElement("div"),c.ref.setAttribute("id",d),c.ref.setAttribute("class",l.owner.options.rowClass),c.ref.setAttribute("style","margin-bottom:0;"),l.parent.rows[d]=c,l.parent.container.appendChild(c.ref)}c.used+=parseInt(l.columns,10),c.used+=parseInt(l.offset,10),c.ref.appendChild(l.el),l.row=d}if(gform.types[l.type].initialize.call(l),l.fields){var p={};p=l.array&&"object"==typeof(e[l.name]||l.owner.options.data[l.name])?(e[l.name]||l.owner.options.data[l.name])[i||0]||{}:e[l.name]||l.owner.options.data[l.name]||{},l.fields=_.map(l.fields,gform.createField.bind(this,l,p,null,null)),l.array&&_.each(l.fields,gform.inflate.bind(this,p))}return gform.processConditions.call(l,l.show,function(t){this.el.style.display=t?"block":"none",this.visible=t}),gform.processConditions.call(l,l.edit,function(t){this.editable=t,gform.types[this.type].edit.call(this,this.editable)}),gform.processConditions.call(l,l.parse||l.show,function(t){this.parsable=t}),l.required&&gform.processConditions.call(l,l.required,function(t){this.required!==t&&this.update({required:t})}),l},gform.rows={add:function(t){var e=gform.getUID();return cRow={},cRow.used=0,cRow.ref=document.createElement("div"),cRow.ref.setAttribute("id",e),cRow.ref.setAttribute("class",this.options.rowClass),cRow.ref.setAttribute("style","margin-bottom:0;"),t.rows[e]=cRow,t.container.appendChild(cRow.ref),cRow},remove:function(){}},gform.ajax=function(t){var e=new XMLHttpRequest;e.onreadystatechange=function(){4===e.readyState&&(200===e.status?t.success(JSON.parse(e.responseText)):(console.log(e.responseText),t.error(e.responseText)))},e.open(t.verb||"GET",t.path),e.send()},gform.default={},gform.options={autoFocus:!0},gform.prototype.opts={clear:!0,sections:"",suffix:":",rowClass:"row",requiredText:'<span style="color:red">*</span>'},gform.eventBus=function(t,e){this.options=t||{owner:"form",item:"field"},this.owner=e||this,this.handlers=t.handlers||{},_.each(this.handlers,function(t,e,n){"function"==typeof t&&(n[e]=[t])}),this.dispatch=function(t,e,n){(n=n||{})[this.options.owner]=this.owner,void 0!==e&&(n[this.options.item]=e),n.default=!0,n.continue=!0,n.preventDefault=function(){n.default=!1}.bind(this),n.stopPropagation=function(){n.continue=!1}.bind(this);var i=[];return"string"==typeof t?i.push(t):i=i.concat(t),_.each(i,function(t,e){t.event=e;var i=function(e){n.continue&&e.call(null,t)}.bind(this);_.each(this.handlers[e],i),_.each(this.handlers["*"],i)}.bind(this,n)),n}.bind(this),this.on=function(t,e){var n=t.split(" ");return"object"!=typeof this.handlers[t]&&(this.handlers[t]=[]),_.each(n,function(t){this.handlers[t].push(e)}.bind(this)),this.owner}.bind(this)},gform.mapOptions=function(t,e,n){this.eventBus=new gform.eventBus({owner:"field",item:"option"},this),this.optgroup=_.extend({},t),n=n||0;var i=this.optgroup.format;function o(t){return _.map(t,function(t){if("object"==typeof t&&"optgroup"==t.type)return t.map=new gform.mapOptions(t,e,n),t.map.sub("*",function(t){this.eventBus.dispatch(t.event)}.bind(this)),t.id=gform.getUID(),gform.processConditions.call(this,t.edit,function(t,e){for(var n=this.el.querySelectorAll('[data-id="'+t+'"]'),i=0;i<n.length;i++)n[i].disabled=!e}.bind(this,t.id)),gform.processConditions.call(this,t.show,function(t,e){for(var n=this.el.querySelectorAll('[data-id="'+t+'"]'),i=0;i<n.length;i++)n[i].hidden=!e}.bind(this,t.id)),t;var o=_.extend({},t);return o.data=t,"string"!=typeof t&&"number"!=typeof t&&"boolean"!=typeof t||(o.label=o.value=t),o.index=t.index||""+n,void 0!==i&&(void 0!==i.label&&(o.label=gform.renderString(i.label,o)),void 0!==i.value&&(o.value=gform.renderString(i.value,o))),(o.value==e||this.multiple&&e.indexOf(o.value)>=0)&&(o.selected=!0),n+=1,o.i=n,o}.bind(this))}switch(this.optgroup.options=this.optgroup.options||[],typeof this.optgroup.options){case"string":this.optgroup.path=this.optgroup.path||this.optgroup.options,this.optgroup.options=[];break;case"function":this.optgroup.action=this.optgroup.options,this.optgroup.options=[]}if(void 0!==this.optgroup.max&&""!==this.optgroup.max)for(var s=this.optgroup.min||0;s<=this.optgroup.max;s+=this.optgroup.step||1)this.optgroup.options.push(""+s);return void 0!==this.optgroup.action&&(this.optgroup.options=this.optgroup.options.concat(o.call(this,this.optgroup.action.call(this)))),_.isArray(this.optgroup.options)&&(this.optgroup.options=o.call(this,this.optgroup.options)),void 0!==this.optgroup.path&&((this.collections||gform.collections).on(this.optgroup.path,function(t){this.optgroup.options=o.call(this.optgroup.map,t.collection),this.eventBus.dispatch("change")}.bind(this)),void 0===(this.collections||gform.collections).get(this.optgroup.path)?((this.collections||gform.collections).add(this.optgroup.path,[]),gform.ajax({path:this.optgroup.path,success:function(t){(this.collections||gform.collections).update(this.optgroup.path,t)}.bind(this)})):this.optgroup.options=o.call(this.optgroup.map,(this.collections||gform.collections).get(this.optgroup.path))),{getobject:function(){return _.map(this.optgroup.options,function(t){return void 0!==t.map?(t.options=t.map.getoptions(),{optgroup:{label:t.label||"",options:t.map.getoptions()}}):t})}.bind(this),getoptions:function(t){var e=[];return _.each(this.optgroup.options,function(t){void 0!==t.map?e=e.concat(t.map.getoptions()):e.push(t)}),void 0!==t?_.find(e,t):e}.bind(this),sub:this.eventBus.on,handlers:this.handlers,optgroup:this.optgroup}},gform.collectionManager=function(t){var e=t||{};return this.eventBus=new gform.eventBus({owner:"manager",item:"collection",handlers:{}},this),{add:function(t,n){e[t]=n},get:function(t){return e[t]},update:function(t,n){e[t]=n,this.eventBus.dispatch(t,e[t])}.bind(this),on:this.eventBus.on}},gform.collections=new gform.collectionManager,gform.render=function(t,e){return gform.m(gform.stencils[t||"text"]||gform.stencils.text,_.extend({},gform.stencils,e))},gform.create=function(t){return document.createRange().createContextualFragment(t).firstElementChild},gform.renderString=function(t,e){return gform.m(t||"",e||{})},gform.addClass=function(t,e){t.className=_.chain(t.className).split(/[\s]+/).union(e.split(" ")).join(" ").value()},gform.removeClass=function(t,e){t.className=_.chain(t.className).split(/[\s]+/).difference(e.split(" ")).join(" ").value()},gform.toggleClass=function(t,e,n){n?gform.addClass(t,e):gform.removeClass(t,e)},gform.VERSION="0.0.0.7",gform.i=0,gform.getUID=function(){return"f"+gform.i++};
